...
public class HashCodeGenearate {
 ...
 {  
     ...
     String saltvalue = PassBasedEnc1.getSaltvalue(30);  
       
     /* generates an encrypted password. It can be stored in a database.*/  
     String encryptedpassword = PassBasedEnc1.generateSecurePassword(password, saltvalue);  
     ...
     Boolean status = PassBasedEnc1.verifyUserPassword(s,encryptedpassword,saltvalue);  
     if(status==true)  
...
{  
 ...
 public static void main(String args[]){
     ...
     boolean b= verifyUserPassword("123456", "gJDLiob9NcSHKR+WQrAhLCD0AnNeFJ/Fm8y92sD3m1U=", "qOkB1uR1m8EcsHmXT73CmCse13WDd3");
